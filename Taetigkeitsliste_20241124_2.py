...
def create_task_list(year, month, tasks, first_name, last_name, mitarbeiternummer, wochenarbeitszeit, resturlaub):
    ...
    for day in range(1, days_in_month + 1):
        ...
        if holiday:
            ...
            # Begrenze num_tasks auf die Länge der Aufgabenliste
            num_tasks = random.randint(2, min(5, len(tasks)))  # Mindestens 2, maximal 5, aber nicht größer als die Anzahl der Aufgaben
