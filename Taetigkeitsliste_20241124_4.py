...
def create_task_list(year, month, tasks, first_name, last_name, mitarbeiternummer, wochenarbeitszeit, resturlaub):
    ...
    for day in range(1, days_in_month + 1):
        ...
        # Berechnung der täglichen Arbeitszeit zwischen 6 und 8 Stunden
        work_minutes = random.randint(360, 480)  # zwischen 6:00h (360 Minuten) und 8:00h (480 Minuten)
    ...
    print(f"\nSollarbeitszeit im Monat: {total_soll_hours}:{total_soll_minutes:02d} Stunden")
    ...
    print(f"Gesamtarbeitszeit im Monat: {total_hours_worked}:{total_minutes_worked:02d} Stunden")
    ...
    print(f"Differenz: {diff_hours}:{diff_minutes} ")
