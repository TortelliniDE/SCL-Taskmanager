...
print("Gib den Namen der Excel-Datei mit der Liste der Projekte und Aufgaben ein, an denen du diesen Monat gearbeitet hast.")
excel_file = input("z.B. Projecte_12_2024.xlsx):  ")
